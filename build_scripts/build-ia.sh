...
if [[ $PLATFORM != windows ]]; then
    ...
    export PATH="$(cd '/c/Program Files (x86)/Microsoft Visual Studio/2017/BuildTools/VC/Auxiliary/Build' && cmd //c 'VcVarsAll.bat amd64 && C:\Program^ Files\Git\bin\bash.exe -c "printenv PATH"')"
    echo "exited?"
